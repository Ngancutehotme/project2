                        ...
                        <div class="card card-hidden">
                            ...
                            <div class="content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" id="password" placeholder="Password" name="mat_khau"class="form-control">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="footer text-center">
                                <button type="submit" id="b" class="btn btn-fill btn-warning btn-wd">Login</button>
                            </div>
                        </div>
